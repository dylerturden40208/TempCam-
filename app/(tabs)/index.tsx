...
import { FlatList, Image, Modal, PanResponder, StyleSheet, Text, TouchableOpacity, View } from 'react-native';
...
export default function CameraScreen() {
  ...
  // Capture Photo and Store Locally
  ...
  const handleTakePicture = async () => {
    ...
    try {
      ...
      if (photo && photo.uri) {
        ...
        // Ensure file directory exists and write photo cleanly
        await FileSystem.copyAsync({
          from: photo.uri,
          to: newPath,
        });
